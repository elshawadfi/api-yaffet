...
Route::get('/getMetalValue' , [ ShowController::class, 'getMetalBasedOnDate']);

Route::get('/lastprices' , [ ShowController::class, 'getLastPrices']);

Route::get('/prices-history' , [ ShowController::class, 'getMetalPriceHistory']);
	
Route::get('/getHighestPrice' , [ ShowController::class, 'getHighestPrice']);
